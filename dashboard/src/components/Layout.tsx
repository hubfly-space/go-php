    ...
    <div className="flex h-screen overflow-hidden bg-bg">
      ...
      >
        <div className="flex items-center gap-3 px-5 h-16 border-b border-border shrink-0">
          ...
          <div>
            <span className="text-sm font-semibold text-text tracking-tight">Gateway</span>
        ...
        <div className="px-4 py-3 border-t border-border">
          <div className="text-[11px] text-text-muted">go-php-gateway</div>
        </div>
      </aside>

      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 border-b border-border flex items-center px-4 lg:px-6 shrink-0 bg-surface/50 backdrop-blur-sm">
          <button
            onClick={() => setSidebarOpen(true)}
            className="lg:hidden text-text-secondary hover:text-text mr-3"
          >
