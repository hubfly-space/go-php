...
## Run fuzz tests (5s smoke per target)
test-fuzz:
	go test -fuzz=FuzzPathParser -fuzztime=5s ./internal/filesystem/...
	go test -fuzz=FuzzPathResolverInputs -fuzztime=5s ./internal/filesystem/...
	go test -fuzz=FuzzArchiveExtractor -fuzztime=5s ./internal/filesystem/...
	go test -fuzz=FuzzHtaccessTranslator -fuzztime=5s ./internal/diagnostics/...
	go test -fuzz=FuzzFastCGIRecordParser -fuzztime=5s ./internal/php/fastcgi/...
	go test -fuzz=FuzzFastCGIParams -fuzztime=5s ./internal/php/fastcgi/...
	go test -fuzz=FuzzDecodeLength -fuzztime=5s ./internal/php/fastcgi/...
	go test -fuzz=FuzzCGIResponseHeaders -fuzztime=5s ./internal/php/cgi/...
	go test -fuzz=FuzzByteSizeParser -fuzztime=5s ./internal/config/...
	go test -fuzz=FuzzDurationParser -fuzztime=5s ./internal/config/...
	go test -fuzz=FuzzConfigDecoder -fuzztime=5s ./internal/config/...
	go test -fuzz=FuzzRewriteEngine -fuzztime=5s ./internal/router/...
	go test -fuzz=FuzzHostParser -fuzztime=5s ./internal/router/...
	go test -fuzz=FuzzForwardedHeaderParser -fuzztime=5s ./internal/observability/...
	go test -fuzz=FuzzMultipartMetadata -fuzztime=5s ./internal/policy/...
	go test -fuzz=FuzzRuntimeManifest -fuzztime=5s ./internal/runtime/...
